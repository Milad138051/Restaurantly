                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.category.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="description" id="description" class="form-control form-control-sm">{{ old('description') }}</textarea>
                            @error('description')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control form-control-sm">
                                <option value="0" @if(old('status') == 1) selected @endif>فعال</option>
                                <option value="1" @if(old('status') == 0) selected @endif>غیرفعال</option>
                            </select>
                            @error('status')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
